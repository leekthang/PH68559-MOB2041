...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DEFAULT_CHECKOUT_CUSTOMER_NAME = "Lưu Văn Quý";
    ...
    private void seedData(SQLiteDatabase db) {
        ...
        nv.put("ma", "NV01");
        nv.put("ho_ten", "Lê Khắc Thắng");
        nv.put("dia_chi", "Hà Nội");
        nv.put("chuc_vu", "Thu ngân");
        nv.put("luong", 12000000);
        db.insert(TABLE_NHAN_VIEN, null, nv);

        insertEmployeeLogin(db, "nv01", DEFAULT_EMPLOYEE_PASSWORD, "Lê Khắc Thắng");

        long hd1 = insertHoaDon(db, "HD001", "Lê Khắc Thắng", "Nguyễn Văn An", "2025-03-10", 143000);
        insertChiTiet(db, hd1, 1, "Bánh quy bơ LU Pháp", 3, 45000);
        insertChiTiet(db, hd1, 2, "Snack mực lăn muối ớt", 1, 8000);

        long hd2 = insertHoaDon(db, "HD002", "Lê Khắc Thắng", "Trần Thị Bình", "2025-04-15", 62000);
        insertChiTiet(db, hd2, 3, "Snack khoai tây Lays", 4, 12000);
        insertChiTiet(db, hd2, 5, "Kẹo sữa sô cô la", 1, 25000);

        long hd3 = insertHoaDon(db, "HD003", "Lê Khắc Thắng", "Nguyễn Văn An", "2025-04-20", 30000);
